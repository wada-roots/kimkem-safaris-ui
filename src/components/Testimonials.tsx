...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      image: "/images/testimonials/michael-chen.jpeg",
    },
    {
      id: 3,
      name: "Emma Rodriguez",
      ...
      image: "/images/testimonials/emma-rodriguez.jpeg",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-safari-green-600 max-w-2xl mx-auto leading-relaxed">
            Hear from adventurers who have experienced the magic of African
            safaris with us. Their stories inspire us to continue delivering
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center">
                ...
                />
                <div>
                  <div className="font-semibold text-safari-green-800">
                    {testimonial.name}
                  </div>
                  <div className="text-sm text-safari-green-600">
        ...
        <div className="text-center mt-16 p-8 bg-white rounded-2xl shadow-lg">
          <h3 className="text-2xl font-bold mb-4 safari-text-gradient">
            Ready to Create Your Own Safari Story?
          </h3>
          <p className="text-safari-green-600 mb-6">
            Join thousands of satisfied travelers who have experienced the
            adventure of a lifetime.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="safari-btn-primary">Plan Your Safari</button>
            <button className="safari-btn-secondary">Read More Reviews</button>
          </div>
        </div>
      </div>
    </section>
